...
import org.grampus.swagger.model.Model;
...
public class ParameterSpec {
    ...
    public static Builder newBuilder(final MethodSpec.Builder methodDescriptor) {
    ...
    public static final class Builder {
        ...
        private Class collectionOf;
        private String defaultValue;
        private MethodSpec.Builder methodDescriptor;

        private Builder() {
        }

        private Builder(final MethodSpec.Builder methodDescriptor) {
        ...
        public ParameterSpec build() {
            ...
            parameterSpec.setName(name);
            parameterSpec.setPattern(pattern);
            parameterSpec.setType(type);
            parameterSpec.setDescription(description);
            parameterSpec.setRequired(required);
            parameterSpec.setExample(example);
            parameterSpec.setAllowEmptyValue(allowEmptyValue);
            parameterSpec.setModel(model);
            parameterSpec.setObject(object);
            parameterSpec.setCollectionOf(collectionOf);
            parameterSpec.setDefaultValue(defaultValue);
            return parameterSpec;
        }

        public MethodSpec.Builder and() {
