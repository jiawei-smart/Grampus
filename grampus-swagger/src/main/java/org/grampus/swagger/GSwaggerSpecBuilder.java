...
import org.grampus.swagger.model.factory.DefinitionsFactory;
import org.grampus.swagger.model.factory.ParamsFactory;
import org.grampus.swagger.model.parameters.BodyParameter;
import org.grampus.swagger.model.parameters.Parameter;
...
public class GSwaggerSpecBuilder {
    ...
    public void build() {
        GLogger.debug("Spark-Swagger: Start parsing metadata");
        if (swagger.getApiEndpoints() != null) {
                ...
                endpoint.getMethodDescriptors()
                        .forEach(methodDescriptor -> {
                            ...
                            if (responses != null && !responses.isEmpty()) {
                                ...
                                org.grampus.swagger.model.Response responseBody = buildResponseFromType(methodDescriptor);
            ...
            GLogger.debug("Spark-Swagger: metadata successfully parsed");
        } else {
            GLogger.debug("Spark-Swagger: No metadata to parse. Please check your SparkSwagger configurations and Endpoints Resolver");
        }
    }
